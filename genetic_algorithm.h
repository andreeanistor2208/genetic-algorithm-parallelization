...
// performs one-point crossover, debug argument will be removed in final version
void crossover(individual *parent1, individual *child1, int generation_index, int debug);
